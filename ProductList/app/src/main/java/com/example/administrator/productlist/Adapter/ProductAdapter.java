package com.example.administrator.productlist.Adapter;
...
import com.example.administrator.productlist.R;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyViewHolder> {
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(final View itemView) {
            ...
            textView1=(TextView)itemView.findViewById(R.id.pruductname);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemview = LayoutInflater.from(parent.getContext()).inflate(R.layout.productlist,parent,false);
